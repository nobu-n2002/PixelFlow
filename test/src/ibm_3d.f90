program main
  ...
  open (300, file='etc/grid.dat', status='replace')
  ! ----------------
  write(300,*)'m, n, l =', m, n, l
  write(300,*)'grid points ='
  write(300,*) (xp(i), i=1,m)
  write(300,*) (yp(j), j=1,n)
  write(300,*) (zp(k), k=1,l)
  ! ----------------
  close (300)
  return
  ...
  open (300, file='etc/cellcenter.dat', status='replace')
  ! ----------------
